...
export function SearchBar({
  ...
  return (
    <div className="flex items-center gap-2 rounded-md border border-slate-200 bg-[var(--surface-subtle)] p-1.5">
...
export function ResultRow({ className, children }: { className?: string; children: ReactNode }) {
  return (
    <div className={cn("flex items-center justify-between gap-3 rounded-md border border-slate-200 bg-white px-3 py-3 shadow-sm shadow-slate-950/[0.03]", className)}>
      {children}
    </div>
  );
}
