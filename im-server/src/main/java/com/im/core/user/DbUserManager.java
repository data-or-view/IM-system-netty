...
public class DbUserManager implements IUserManager, IUserCredentialStore {
    ...
    private UserInformation toUserInformation(UserEntity entity) {
        ...
        info.setAppMangerLevel(UserAdminLevel.fromCode(entity.getAppMangerLevel()));
        info.setGlobalRecvMsgOpt(MessageReceiveOption.fromCode(entity.getGlobalRecvMsgOpt()));
