...
public class WsPushEventEncoder extends MessageToMessageEncoder<WsPushEvent> {

    private static final Logger log = LoggerFactory.getLogger(WsPushEventEncoder.class);
    private static final ObjectMapper MAPPER = ObjectMapperProvider.get();

    @Override
    protected void encode(ChannelHandlerContext ctx, WsPushEvent event, List<Object> out) {
        try {
