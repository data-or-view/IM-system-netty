 ...
 * 纯数据类，不含业务逻辑。
 *
 * <p>可通过 {@link #from(Properties)} 加载。</p>
 */
public class ServerConfiguration {
     ...
     * props.setProperty("im.ws.port", "8081");
    ...
    public static ServerConfiguration from(Properties props) {
        ...
        cfg.httpPort = get(props, "im.http.port", DEFAULT_HTTP_PORT);
        cfg.httpEnabled = get(props, "im.http.enabled", DEFAULT_HTTP_ENABLED);
