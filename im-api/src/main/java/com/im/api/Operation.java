...
public enum Operation {
    ...
    GROUP_OWNER_TRANSFER("group.owner.transfer", "POST", "/api/group/owner/transfer", true, TransportType.HTTP_ONLY),
    GROUP_MEMBER_ROLE_SET("group.member.role.set", "POST", "/api/group/member/role", true, TransportType.HTTP_ONLY),
    GROUP_MEMBER_INFO_UPDATE("group.member.info.update", "POST", "/api/group/member/info/update", true, TransportType.HTTP_ONLY),
