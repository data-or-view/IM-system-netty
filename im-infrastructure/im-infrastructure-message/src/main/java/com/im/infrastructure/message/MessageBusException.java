 ...
 * 避免将中间件错误当作业务异常处理。
 */
public class MessageBusException extends InfrastructureException {

    public MessageBusException(String message) {
        super(ImErrorCode.MQ_UNAVAILABLE, message);
    }

    public MessageBusException(String message, Throwable cause) {
        super(ImErrorCode.MQ_UNAVAILABLE, message, cause);
    }
