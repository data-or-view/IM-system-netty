...
import com.im.api.retry.RetryConfig;
import com.im.api.retry.RetryExecutor;
import com.im.api.retry.RetryStrategies;
...
public class DbConversationManager implements IConversationManager {
     ...
     */
    private String buildAttachedInfo(IMCommand msg) {
        String mid = msg.getMessageId();
        String content = msg.getHeader("content");
        String ct = msg.getHeader("contentType");
